(*type game_mode (** The abstract data type representing the the different game
  ...
  the given score calculated in get_data and interface, as well as keeping track
  of rounds and when the game ends.*)
  ...
  val get_round_score_total : t -> int array (** [get_round_score_total] game is
  the cumulative score for every player in the current round. *)
  ...
  val get_winner : t -> string (** [get_winner] game is the winner of the round,
  call this function if game ends to determine final winner. *)
